        ...
        <div class="row maincontainer" style="text-align:center;margin:10px 25vw; padding:32px;border-radius:32px;box-shadow: 3px 3px 32px 5px rgba(0,0,0,0.5);">
            ...
            <div class="row">
                ...
                <div style="background-color:rgba(185, 207, 255);color:rgba(15,31,88);">
                    ...
                    <a style='text-decoration:none; margin: 10px 15px; padding:10px 15px; border-radius:32px; color: #fff; background-color:rgba(15,31,88);' href='tensaiedu.online/Accounts/Confirmation/confirm.php?email=%s&role=%s&code=%s'> Confirm Email </a>
                </div>
