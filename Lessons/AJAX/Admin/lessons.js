function getLessons() {
    ...
    // Data
    var search = document.querySelector("#searchLesson");
    //

    request.open("POST", "AJAX/Admin/getLessons.php");
        ...
        if (this.readyState === 4 && this.status === 200) {
            ...
            try {
                ...
                for (i = 0; i < lessons.length; i++) {
                    ...
                    var td_desc = createData(!lessonDesc ? "No description" : lessonDesc);
...
function lessons_edit() {

}

function lessons_delete(lessonID, lessonName) {
    var delTxt = document.getElementById("delTxt");
    var delBtn = document.getElementById("delBtn");

    delTxt.innerText = lessonName;

    delBtn.setAttribute("onClick", "deleteLesson("+lessonID+", true)");
}