...
<head>
    ...
    <title>TENSAI - Lesson List</title>
...
<body>
    ...
    <div class="tensai-body" style="background-image: url('../src/s1.jpg');">
        <div class="color-overlay d-flex flex-column">
            <div class="tensai-head d-flex align-se">
                <div class="mb-2 p-3 justify-content-start align-items-start">
                <h1 class=>LESSONS</h1>
                </div>

                <div class="mb-2 p-4 ms-auto">
                    <a href="#" class="form-control" onClick="history.go(-1)" id="btn_back"><i class="bi bi-arrow-return-left"></i> GO BACK</a>
                </div>
            </div>
            ...
            <div class="container-fluid">
                ...
                <div class="row row-cols-5 row-cols-md-2 g-4 mt-3">
                    ...
                    <div class="tensai-lesson d-flex flex-row">
                        <div class="card-group" id="cont_lessons">
                            <!--Sample card-->
                            <div class="card border-palette3 bg-transparent" style="width: 15rem;">
                                <img src="images/AoyamaSan.jpg" class="card-img-top">
                                <div class="card-body">
                                    <h5 class="card-title">LESSON 1</h5>
                                    <p class="card-text">This is about SCIENCE!!</p>
                                    <a href="viewer.php" class="btn btn-palette3">VIEW LESSON</a>
                                </div>
                            </div>
