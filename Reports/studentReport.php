        ...
        <div>
            ...
            <div class="row">
                <div class="col" id="perf_monthly">
                    <p><b>Monthly Performance:</b> <?php echo $monthlyAve[0] == "Not Enough Data" ? $monthlyAve[0] : $monthlyAve[0] . "%"; ?></p>
                    <p>Times Taken: <?php echo $monthlyAve[1]; ?></p>
                </div>

                <div class="col" id="perf_weekly">
                    <p><b>Weekly Performance:</b> <?php echo $weeklyAve[0] == "Not Enough Data" ? $weeklyAve[0] : $weeklyAve[0] . "%"; ?></p>
